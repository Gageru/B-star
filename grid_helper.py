...
def generate_grid_weighted_v2():
    return [["#","#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#"],
            ["#",  1,   1,   1,   1,   1,   1, "#",   6, "#",   1,   1,   1, "#",   8,   1,   1, "#",   5, "#",   9, "#",   5, "#", "#",   2,   1,   2, "#", "#"],
            ["#",  1,   1,   1,   1,   1,   1, "#",   5, "#",   1,   1,   1,   6,   7,   6,   1,   1,   1,   8,   7,   6, "#", "#",   1, "#", "#",   1, "#", "#"],
            ["#",  1, "#", "#",   1, "#", "#", "#",   4, "#", "#", "#", "#",   5, "#", "#",   2,   1,   2,   3,   1,   1,   1,   1,   2, "#", "#",   4,   1, "#"],
            ["#",  1,   1,   2,   3,   2,   1,   2,   3,   1,   1,   1,   1,   4,   1,   2,   1, "#", "#",   4, "#", "#", "#",   4,   3,   2,   1,   1, "#", "#"],
            ["#",  1, "#", "#",   4, "#", "#", "#",   4,   3,   2,   1,   1,   3, "#", "#",   1,   6, "#",   1, "#",   1,   1, "#",   1,   1,  "#",  1,   6, "#"],
            ["#",  1,   1, "#",   5, "#",   9, "#",   5, "#", "#",   2,   1,   2, "#", "#",   5, "#", "#", "#",   8, "#",   7,   8,   1,   1,  "#","#",   5, "#"],
            ["#",  1,   1, "#",   6,   7,   8, "#",   6, "#",   4,   3, "#",   1,   1,   2,   1, "#", "#",   1, "#", "#", "#",   4, "#", "#", "#", "#",   5, "#"],
            ["#",  2, "#", "#",   7, "#", "#", "#",   7, "#",   5,   4, "#",   1,   1, "#",   6, "#",   1,   1,   1, "#",   8,   1,   1, "#",   5, "#",   6, "#"],
            ["#",  3,   4,   5,   6,   1,   1,   1,   8,   7,   6, "#", "#",   1, "#", "#",   2,   3,   2,   1,   2,   3,   1,   1,   1,   1,   4,   1, "#", "#"],
            ["#",  1, "#", "#",   5, "#", "#", "#",   8, "#",   7,   8,   1,   1, "#", "#",   5,   4, "#",   1,   1, "#",   6, "#",   1,   1,   1, "#",   1, "#"],
            ["#",  1,   1, "#",   4, "#",   8,   9,  10,   1,   1,   9,  10,   1,   1,   3,   1,   6, "#",   1, "#",   1,   1, "#",   1,   1,  "#",  1,   6, "#"],
            ["#",  1,   1, "#",   3, "#",   7,   1,   1,   1, "#",   1, "#", "#",   1,   2,   4,   3, "#",   1,   1, "#",   1,   2,   2,   1, "#", "#",   1, "#"],
            ["#",  1,   1,   1,   2,   1,   6, "#",   1, "#",   1,   1, "#",   1,   1,   3,   1, "#",   1,   3, "#",   1, "#",   4,   3, "#",   1,   1, "#", "#"],
            ["#",  1,   1,   2,   3,   2,   1,   2,   3,   1,   1,   1,   1,   4,   1,   2,   1, "#", "#",   4,   5, "#", "#",   4,   3,   2,   1,   1, "#", "#"],
            ["#",  1,   1, "#",   5, "#",   9, "#",   5, "#", "#",   2,   1,   2, "#", "#",   5, "#", "#", "#",   8, "#",   7,   8,   1,   1,  "#","#",   5, "#"],
            ["#",  1,   1, "#",   5, "#",   9, "#",   5, "#", "#",   2,   1,   2, "#", "#",   5, "#", "#", "#",   8, "#",   7,   8,   1,   1,  "#","#",   5, "#"],
            ["#",  1,   1,   1,   1,   1,   1, "#",   6, "#",   1,   1,   1, "#",   8,   1,   1, "#",   5, "#",   9, "#",   5, "#", "#",   2,   1,   2, "#", "#"],
            ["#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#","#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#"]]
